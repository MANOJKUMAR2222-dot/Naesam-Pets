...
BASE_DIR = "naesam-pets-frontend"

# Your React Code (The large block you provided)
REACT_APP_CODE = r"""import React, { useState, useEffect } from 'react';
...
# File structure for Vite + React + Tailwind
files = {
    # 1. Package configuration (dependencies)
    "package.json": """{
  "name": "naesam-pets-frontend",
  "private": true,
  "version": "1.0.0",
  "type": "module",
  "scripts": {
...
export default {
  ...
  plugins: [],
    ...
    # 4. PostCSS Config (needed for Tailwind)
...
<html lang="en">
  <head>
    ...
    <title>Naesam Pets - Ethical Rescue & Adoption</title>
  </head>
  <body>
    <div id="root"></div>
...
import NaesamPetsApp from './App.jsx'
import './index.css'
...
ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    ...
    # 8. THE MAIN APP CODE (The one you provided)
    "src/App.jsx": REACT_APP_CODE
}

def create_frontend_structure():
    print(f"🚀 Generating Frontend: {BASE_DIR}...")
    ...
    print(f"✅ Frontend created successfully at ./{BASE_DIR}")
    print("\nNext steps:")
